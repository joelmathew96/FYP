   ...
   text-align: center;
    ...
    <body>
      ...
      <header>
        ...
          <h1>FACULTY OF EDUCATION & PSYCHOLOGY</h1>

          <p>The Faculty of Education and Public Welfare at Southern University College is established with diverse facilities in the Southern region of Malaysia for the initial and advanced training of education professionals. This faculty has the widest range of academic programmes for students who intend to embark on education studies. The faculty offers variety of educational courses with special features and focuses to further enhance the quality of education in the society. There are four home-grown degrees and one diploma programme. All programs have been approved by the Malaysian Qualifications Agency (MQA) and Ministry of Higher Education. These programs are Bachelor of Early Childhood Education (Hons), Bachelor of Psychology (Honours), Bachelor of Education (Honours) Guidance & Counselling, Bachelor of Education (Honours) Information Technology & Multimedia and Diploma in Early Childhood Education.

 

            We are inspired to prepare teachers, scholars and community leaders with the knowledge and dedication to address the challenges faced by our students and our education systems. We are committed to providing students with an educational experience that will serve them for a lifetime. Our team strongly believes that "Only diversity makes change and progress."
            
             
            
            The function of education is to teach one to think intensively and to think critically. Intelligence plus character - that is the goal of true education." -Martin Luther King, Jr.</p>
          ...
          <div class="anchortabcontainer aem-GridColumn aem-GridColumn--default--12">
           ...
           <nav>
            <ul>
                <img src="{{ asset('assets/img/FEP.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="http://127.0.0.1:8000/BECE"  class="lblBECE" style="float:right">Bachelor of Early Childhood Education(Honours)</a>
                <a href="http://127.0.0.1:8000/BPSY"  class="lblBPSY" style="float:right">Bachelor of Psychology(Honours)</a>
                <a href="http://127.0.0.1:8000/BEGC"  class="lblBEGC" style="float:right">Bachelor of Education(Honours)(Guidance & Counselling)</a>
                <a href="http://127.0.0.1:8000/DECE"  class="lblDECE" style="float:right">Diploma in Early Childhood Education</a>
