   ...
   text-align: center;
    ...
    <body>
      ...
      <header>
        ...
          <h1>FACULTY OF CHINESE MEDICINE</h1>

          <p>Founded in 2009, Faculty of Chinese Medicine (FCM) is one of the eldest, most prestigious Chinese medicine schools in Southern region in Peninsular Malaysia. Distinguished faculty and a rigorous curriculum have established FCM as a truly exceptional programme that brings in students from all over the world. As part of Southern University College, FCM is supported by the local Chinese community while serving nationwide.

 

            Our faculty offers 2 programmes, included Foundation in Traditional Chinese Medicine and Bachelor of Traditional Chinese Medicine (Hons). Our students, alumni, and faculty are deeply engaged in the community and at the forefront of integrative care and public health.
            
             
            
            Our faculty aims to cultivate and train the next generation of Traditional Chinese Medicine practitioners and health care professionals, with the spirit of professionalism and humanism. Our programmes aim to enhance students’ competitiveness in employment or professional career planning, while making remarkable discoveries, and creating pathways to a better health for the community.
            
             
            
            The curriculum has been developed to suit the local needs. Clinical practice and fieldwork are the most integral parts of our courses. We offer opportunities for students to gain hands-on experience in clinical and laboratory settings.
            
             
            
            In order to achieve the oath on ‘Health Related, Life Entrusted’, we strive hard to contribute our best towards the development of TCM in Malaysia.</p>
          ...
          <div class="anchortabcontainer aem-GridColumn aem-GridColumn--default--12">
           ...
           <nav>
            <ul>
                <img src="{{ asset('assets/img/TCM.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="http://127.0.0.1:8000/TCM"  class="lblTCM" style="float:right">Bachelor of Traditional Chinese Medicine(Hons)</a>
                <a href="http://127.0.0.1:8000/FTCM"  class="lblFTCM" style="float:right">Foundation in Traditional Chinese Medicine</a>
