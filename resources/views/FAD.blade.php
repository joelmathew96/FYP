   ...
   text-align: center;
    ...
    <body>
      ...
      <header>
        ...
          <h1>FACULTY OF ART & DESIGN</h1>

          <p>The Faculty of Art & Design offers two Bachelor Degree programmes, namely Computer Graphic Design and Industrial Design and three Diploma programmes, namely Advertising Design, Industrial Design, and Multimedia Design. All programmes consist of multi-dimensional courses that not only provide the learning of design theories, but also a channel to exercise students' latent creativity and expression of innovative ideas. In addition, Faculty also organises various activities from time to time and allow students to participate in the off-campus competitions,including Open Day Student Artwork Showcase, May Day Art & Design festival, and Art & Design Graduation Show. Students are able to step out of the classroom for cross-grade and cross-disciplinary learning.</p>
          ...
          <div class="anchortabcontainer aem-GridColumn aem-GridColumn--default--12">
           ...
           <nav>
            <ul>
                ...
                <a href="http://127.0.0.1:8000/CGD"  class="lblCGD" style="float:right">Bachelor of Design(Honours) Computer Graphic Design</a>
                <a href="http://127.0.0.1:8000/ID"  class="lblID" style="float:right">Bachelor of Design(Honours) Industrial Design</a>
                <a href="http://127.0.0.1:8000/AD"  class="lblAD" style="float:right">Diploma in Advertising Design</a>
                <a href="http://127.0.0.1:8000/IND"  class="lblIND" style="float:right">Diploma in Industrial Design</a>
                <a href="http://127.0.0.1:8000/MD"  class="lblMD" style="float:right">Diploma in Multimedia Design</a>
