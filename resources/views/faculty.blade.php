  ...
  border: none;
    ...
    <body>
      ...
      <header>
        ...
          <h1>New Programmes 2020 & 2021</h1>

          <h2>Discover fast-growing & in-demand career fields that resonate with your passion.</h2>
          ...
          <div class="anchortabcontainer aem-GridColumn aem-GridColumn--default--12">
                ...
                <div class="section-scroll-dropdown-nav w-100" id="section-scroll-dropdown2">
                  ...
                  <div class="btn-group btn-dropdown">
                      ...
                      <a href="#our-new-programmes" class="btn-block">
                        <span class="button-text">OUR NEW PROGRAMMES</span><i class="d-lg-none t-icon-right pull-right white ml-3"></i>
           ...
           <h3> Our New Programmes</h3>
          
           <nav>
            <ul>
                <img src="{{ asset('assets/img/BUSINESS.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-fbm.php" class="button">FACULTY OF BUSINESS AND MANAGEMENT</a>
                

                
                
                <img src="{{ asset('assets/img/IT.png') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-feit.php" class="button">FACULTY OF ENGINEERING & INFORMATION  TECHNOLOGY</a>
                
                
                <img src="{{ asset('assets/img/SOCIALSCIENCES.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-fhss.php" class="button">FACULTY OF HUMANITIES AND SOCIAL SCIENCES</a>
               
                
                <img src="{{ asset('assets/img/FAD.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-fad.php" class="button">FACULTY OF ART AND DESIGN</a>
                
                <img src="{{ asset('assets/img/TCM.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-fcm.php" class="button">FACULTY OF CHINESE MEDICINE</a>
                
                <img src="{{ asset('assets/img/FEP.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-fep.php" class="button">FACULTY OF EDUCATION & PSYCHOLOGY</a>
                
                <img src="{{ asset('assets/img/SITE.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-site.php" class="button">SOUTHERN INSITUTE OF TECHNICAL EDUCATION</a>
                
                <img src="{{ asset('assets/img/FOUNDATION.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-sfs.php" class="button">SCHOOL OF FOUNDATION STUDIES</a>
                
                <img src="{{ asset('assets/img/SPACE.jpg') }}" width= "475"  height="320" style="float:top"/>
                <a href="https://southern.edu.my/academic-space.php" class="button">SCHOOL OF PROFESSIONAL CONTINUING EDUCATION</a>
